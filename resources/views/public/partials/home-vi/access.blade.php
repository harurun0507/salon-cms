...
<section id="access" class="home-vi-access" aria-label="Access">
    <div class="home-vi-access__inner">
        <header class="home-vi-access__intro">
            <p class="home-vi-kicker">Access</p>
            <h2 class="home-vi-access__title">店舗情報</h2>
        </header>

        <div class="home-vi-access__cards">
            <article class="home-vi-access__card home-vi-access__card--info">
            ...
            <article class="home-vi-access__card home-vi-access__card--map">
                <div class="home-vi-access__map-frame" aria-hidden="{{ $hasMap ? 'false' : 'true' }}">
                    @if($hasMap)
                        <iframe
            ...
            <article class="home-vi-access__card home-vi-access__card--calendar">
                <x-public.business-calendar variant="access" />
                @php
                    $accessClosedDaysText = \App\Models\SalonSetting::current()->closedDaysDisplayText();
                @endphp
                <div class="site-business-calendar__access-foot">
                    @include('components.public.partials.business-calendar-legend')
                    @if(filled($accessClosedDaysText))
                        <p class="site-business-calendar__holiday-note">※定休日：{{ $accessClosedDaysText }}</p>
                    @endif
                </div>
            </article>
        </div>
